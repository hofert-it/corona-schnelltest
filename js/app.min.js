...
const cookieBtnAccept = document.querySelector(".cookies__btn");
const cookieBtnCancel = document.querySelector(".cookies__close");

cookieBtnAccept.addEventListener("click", () => {
	cookieBanner.classList.remove("_open");
...
setTimeout(() => {
	if (!localStorage.getItem("cookieBannerDisplayed")) {
		cookieBanner.classList.add("_open");
	}
}, 2000);
